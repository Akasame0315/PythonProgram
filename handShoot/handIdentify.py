                    ...
                    if len(result.multi_handedness) == 2:   #判斷有兩隻手
                        if finger_points:
                            ...
                            if finger_points[9][0] > (imgWidth/2):
                                ...
                                cv2.putText(img, f"RText:{Rtext} RSign:{RSign}", (30,90), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3) # 印出文字
                            ...
                            if finger_points[9][0] < imgWidth/2:
                                ...
                                LPos = [finger_points[9][0], finger_points[9][1]]
                                cv2.putText(img, f"LText:{Ltext} LSign:{LSign}", (30,150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3) # 印出文字
